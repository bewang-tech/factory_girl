class Factory
  ...
  def association (name, options = {})
    ...
    define_attribute(Attribute::Association.new(name, factory_name, options))
  end
  ...
  def after_build(&block)
    add_callback(:after_build, &block)
  end
